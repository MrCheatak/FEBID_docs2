...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "febid.libraries.pde.tridiag",
        "sources": [
            "febid/libraries/pde/tridiag.pyx"
        ]
    },
    "module_name": "febid.libraries.pde.tridiag"
}
END: Cython Metadata */
...
#define __PYX_HAVE__febid__libraries__pde__tridiag
#define __PYX_HAVE_API__febid__libraries__pde__tridiag
/* Early includes */
#include <string.h>
#include <stdlib.h>
#include "pythread.h"
...
/* Module declarations from 'febid.libraries.pde.tridiag' */
...
static PyObject *__pyx_f_5febid_9libraries_3pde_7tridiag_adi_3d_indexing(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, double, long, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_5febid_9libraries_3pde_7tridiag_adi_3d(__Pyx_memviewslice, __Pyx_memviewslice, double, long, int __pyx_skip_dispatch); /*proto*/
static PyObject *__pyx_f_5febid_9libraries_3pde_7tridiag_tridiag_1d(__Pyx_memviewslice, __Pyx_memviewslice, double, double, double, double, int __pyx_skip_dispatch); /*proto*/
static void __pyx_f_5febid_9libraries_3pde_7tridiag_tridiag_1d_c(__Pyx_memviewslice, __Pyx_memviewslice, double, double, double, double, double, double); /*proto*/
...
#define __Pyx_MODULE_NAME "febid.libraries.pde.tridiag"
extern int __pyx_module_is_main_febid__libraries__pde__tridiag;
int __pyx_module_is_main_febid__libraries__pde__tridiag = 0;

/* Implementation of 'febid.libraries.pde.tridiag' */
...
static const char __pyx_k_Tridiagonal_parallel_matrix_sol[] = "\nTridiagonal parallel matrix solver\n";
static const char __pyx_k_Buffer_view_does_not_expose_stri[] = "Buffer view does not expose strides";
static const char __pyx_k_Can_only_create_a_buffer_that_is[] = "Can only create a buffer that is contiguous in memory.";
static const char __pyx_k_Cannot_assign_to_read_only_memor[] = "Cannot assign to read-only memoryview";
static const char __pyx_k_Cannot_create_writable_memory_vi[] = "Cannot create writable memory view from read-only memoryview";
static const char __pyx_k_Empty_shape_tuple_for_cython_arr[] = "Empty shape tuple for cython.array";
static const char __pyx_k_Exceeding_1e6_iterations_in_trid[] = "Exceeding 1e6 iterations in tridiagonal matrix solution";
...
static PyObject *__pyx_kp_s_Exceeding_1e6_iterations_in_trid;
...
static PyObject *__pyx_pf_5febid_9libraries_3pde_7tridiag_adi_3d_indexing(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_s1, __Pyx_memviewslice __pyx_v_s2, __Pyx_memviewslice __pyx_v_s3, double __pyx_v_a, long __pyx_v_boundaries); /* proto */
static PyObject *__pyx_pf_5febid_9libraries_3pde_7tridiag_2adi_3d(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d, __Pyx_memviewslice __pyx_v_x, double __pyx_v_a, long __pyx_v_boundaries); /* proto */
static PyObject *__pyx_pf_5febid_9libraries_3pde_7tridiag_4tridiag_1d(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d, __Pyx_memviewslice __pyx_v_x, double __pyx_v_b, double __pyx_v_c, double __pyx_v_b0, double __pyx_v_c0); /* proto */
...
/* "febid/libraries/pde/tridiag.pyx":25
...
static PyObject *__pyx_pw_5febid_9libraries_3pde_7tridiag_1adi_3d_indexing(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_5febid_9libraries_3pde_7tridiag_adi_3d_indexing(__Pyx_memviewslice __pyx_v_d, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_s1, __Pyx_memviewslice __pyx_v_s2, __Pyx_memviewslice __pyx_v_s3, double __pyx_v_a, long __pyx_v_boundaries, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_j;
  int __pyx_v_u;
  int __pyx_v_v;
  int __pyx_v_w;
  ...
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("adi_3d_indexing", 0);

  /* "febid/libraries/pde/tridiag.pyx":42
 *         int u, v, w, q
 ...
 *         c0 = -a
 */
  __pyx_t_1 = ((__pyx_v_boundaries == 0) != 0);
  if (__pyx_t_1) {

    /* "febid/libraries/pde/tridiag.pyx":43
 *         double b0, c0, bn, cn  # boundary conditions
 *     if boundaries == 0:
 *         b0 = 1 + 2 * a             # <<<<<<<<<<<<<<
 *         c0 = -a
 *     if boundaries == 1:
 */
    __pyx_v_b0 = (1.0 + (2.0 * __pyx_v_a));

    /* "febid/libraries/pde/tridiag.pyx":44
 *     if boundaries == 0:
 *         b0 = 1 + 2 * a
 *         c0 = -a             # <<<<<<<<<<<<<<
 *     if boundaries == 1:
 ...
 */
  ...
  /* "febid/libraries/pde/tridiag.pyx":45
 *         b0 = 1 + 2 * a
 *         c0 = -a
 *     if boundaries == 1:             # <<<<<<<<<<<<<<
 *         b0 = 1
 *         c0 = 0
 */
  __pyx_t_1 = ((__pyx_v_boundaries == 1) != 0);
  if (__pyx_t_1) {

    /* "febid/libraries/pde/tridiag.pyx":46
 *         c0 = -a
 *     if boundaries == 1:
 *         b0 = 1             # <<<<<<<<<<<<<<
 *         c0 = 0
 ...
 */
    ...
    /* "febid/libraries/pde/tridiag.pyx":47
 *     if boundaries == 1:
 *         b0 = 1
 *         c0 = 0             # <<<<<<<<<<<<<<
 *     if boundaries == 2:
 ...
 */
  ...
  /* "febid/libraries/pde/tridiag.pyx":48
 *         b0 = 1
 *         c0 = 0
 *     if boundaries == 2:             # <<<<<<<<<<<<<<
 *         b0 = 1 + 1 * a
 *         c0 = -a
 */
  __pyx_t_1 = ((__pyx_v_boundaries == 2) != 0);
  if (__pyx_t_1) {

    /* "febid/libraries/pde/tridiag.pyx":49
 *         c0 = 0
 *     if boundaries == 2:
 *         b0 = 1 + 1 * a             # <<<<<<<<<<<<<<
 *         c0 = -a
 *     b = 1 + 2 * a
 */
    __pyx_v_b0 = (1.0 + (1.0 * __pyx_v_a));

    /* "febid/libraries/pde/tridiag.pyx":50
 *     if boundaries == 2:
 *         b0 = 1 + 1 * a
 *         c0 = -a             # <<<<<<<<<<<<<<
 *     b = 1 + 2 * a
 ...
 */
  ...
  /* "febid/libraries/pde/tridiag.pyx":51
 *         b0 = 1 + 1 * a
 *         c0 = -a
 *     b = 1 + 2 * a             # <<<<<<<<<<<<<<
 *     c = -a
 ...
 */
  __pyx_v_b = (1.0 + (2.0 * __pyx_v_a));

  /* "febid/libraries/pde/tridiag.pyx":52
 *         c0 = -a
 *     b = 1 + 2 * a
 *     c = -a             # <<<<<<<<<<<<<<
 *     # for j in prange(0, s1.shape[0], 2, num_threads=4, nogil=True):
 ...
 */
  ...
  /* "febid/libraries/pde/tridiag.pyx":54
 *     c = -a
 *     # for j in prange(0, s1.shape[0], 2, num_threads=4, nogil=True):
 *     for j in range(0, s1.shape[0], 2):             # <<<<<<<<<<<<<<
 *         u = s1[j, 0]
 *         v = s1[j, 1]
 */
  __pyx_t_2 = (__pyx_v_s1.shape[0]);
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=2) {
    __pyx_v_j = __pyx_t_4;

    /* "febid/libraries/pde/tridiag.pyx":55
 *     # for j in prange(0, s1.shape[0], 2, num_threads=4, nogil=True):
 *     for j in range(0, s1.shape[0], 2):
 *         u = s1[j, 0]             # <<<<<<<<<<<<<<
 *         v = s1[j, 1]
 ...
 */
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_s1.shape[0];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_s1.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_6 < 0) {
      __pyx_t_6 += __pyx_v_s1.shape[1];
      if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_6 >= __pyx_v_s1.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 55, __pyx_L1_error)
    }
    __pyx_v_u = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s1.data + __pyx_t_5 * __pyx_v_s1.strides[0]) ) + __pyx_t_6 * __pyx_v_s1.strides[1]) )));

    /* "febid/libraries/pde/tridiag.pyx":56
 *     for j in range(0, s1.shape[0], 2):
 *         u = s1[j, 0]
 *         v = s1[j, 1]             # <<<<<<<<<<<<<<
 *         w = s1[j, 2]
 ...
 */
    ...
    } else if (unlikely(__pyx_t_6 >= __pyx_v_s1.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_s1.shape[1];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_s1.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 56, __pyx_L1_error)
    }
    __pyx_v_v = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s1.data + __pyx_t_6 * __pyx_v_s1.strides[0]) ) + __pyx_t_5 * __pyx_v_s1.strides[1]) )));

    /* "febid/libraries/pde/tridiag.pyx":57
 *         u = s1[j, 0]
 *         v = s1[j, 1]
 *         w = s1[j, 2]             # <<<<<<<<<<<<<<
 *         q = s1[j+1,2]
 ...
 */
    ...
    __pyx_v_w = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s1.data + __pyx_t_5 * __pyx_v_s1.strides[0]) ) + __pyx_t_6 * __pyx_v_s1.strides[1]) )));

    /* "febid/libraries/pde/tridiag.pyx":58
 *         v = s1[j, 1]
 *         w = s1[j, 2]
 *         q = s1[j+1,2]             # <<<<<<<<<<<<<<
 *         tridiag_1d_c(d[u, v, w:q], d[u, v, w:q], b, c, b0, c0, b0, c0)
 ...
 */
    ...
    __pyx_v_q = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s1.data + __pyx_t_6 * __pyx_v_s1.strides[0]) ) + __pyx_t_5 * __pyx_v_s1.strides[1]) )));

    /* "febid/libraries/pde/tridiag.pyx":59
 *         w = s1[j, 2]
 *         q = s1[j+1,2]
 *         tridiag_1d_c(d[u, v, w:q], d[u, v, w:q], b, c, b0, c0, b0, c0)             # <<<<<<<<<<<<<<
 *     # for j in prange(0, s2.shape[0], 2, num_threads=4, nogil=True):
 ...
 */
    __pyx_t_8.data = __pyx_v_d.data;
    __pyx_t_8.memview = __pyx_v_d.memview;
    __PYX_INC_MEMVIEW(&__pyx_t_8, 0);
    {
    Py_ssize_t __pyx_tmp_idx = __pyx_v_u;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_d.shape[0];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_d.strides[0];
        if (__pyx_tmp_idx < 0)
...

{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_v;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_d.shape[1];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_d.strides[1];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        if (unlikely(!__Pyx_is_valid_index(__pyx_tmp_idx, __pyx_tmp_shape))) {
            PyErr_SetString(PyExc_IndexError,
...
__pyx_t_7 = -1;
    ...
    &__pyx_t_8,
    __pyx_v_d.shape[2], __pyx_v_d.strides[2], __pyx_v_d.suboffsets[2],
    2,
    0,
    &__pyx_t_7,
    __pyx_v_w,
...
__pyx_t_9.data = __pyx_v_d.data;
    __pyx_t_9.memview = __pyx_v_d.memview;
...
__pyx_f_5febid_9libraries_3pde_7tridiag_tridiag_1d_c(__pyx_t_8, __pyx_t_9, __pyx_v_b, __pyx_v_c, __pyx_v_b0, __pyx_v_c0, __pyx_v_b0, __pyx_v_c0);
  ...
  /* "febid/libraries/pde/tridiag.pyx":61
 *         tridiag_1d_c(d[u, v, w:q], d[u, v, w:q], b, c, b0, c0, b0, c0)
 *     # for j in prange(0, s2.shape[0], 2, num_threads=4, nogil=True):
 *     for j in range(0, s2.shape[0], 2):             # <<<<<<<<<<<<<<
 *         u = s2[j, 0]
 *         v = s2[j, 1]
 */
  __pyx_t_2 = (__pyx_v_s2.shape[0]);
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=2) {
    __pyx_v_j = __pyx_t_4;

    /* "febid/libraries/pde/tridiag.pyx":62
 *     # for j in prange(0, s2.shape[0], 2, num_threads=4, nogil=True):
 *     for j in range(0, s2.shape[0], 2):
 *         u = s2[j, 0]             # <<<<<<<<<<<<<<
 *         v = s2[j, 1]
 ...
 */
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_s2.shape[0];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_s2.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_6 < 0) {
      __pyx_t_6 += __pyx_v_s2.shape[1];
      if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_6 >= __pyx_v_s2.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 62, __pyx_L1_error)
    }
    __pyx_v_u = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s2.data + __pyx_t_5 * __pyx_v_s2.strides[0]) ) + __pyx_t_6 * __pyx_v_s2.strides[1]) )));

    /* "febid/libraries/pde/tridiag.pyx":63
 *     for j in range(0, s2.shape[0], 2):
 *         u = s2[j, 0]
 *         v = s2[j, 1]             # <<<<<<<<<<<<<<
 *         w = s2[j, 2]
 ...
 */
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_6 < 0) {
      __pyx_t_6 += __pyx_v_s2.shape[0];
      if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_6 >= __pyx_v_s2.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_s2.shape[1];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_s2.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 63, __pyx_L1_error)
    }
    __pyx_v_v = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s2.data + __pyx_t_6 * __pyx_v_s2.strides[0]) ) + __pyx_t_5 * __pyx_v_s2.strides[1]) )));

    /* "febid/libraries/pde/tridiag.pyx":64
 *         u = s2[j, 0]
 *         v = s2[j, 1]
 *         w = s2[j, 2]             # <<<<<<<<<<<<<<
 *         q = s2[j+1,1]
 ...
 */
    ...
    __pyx_v_w = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s2.data + __pyx_t_5 * __pyx_v_s2.strides[0]) ) + __pyx_t_6 * __pyx_v_s2.strides[1]) )));

    /* "febid/libraries/pde/tridiag.pyx":65
 *         v = s2[j, 1]
 *         w = s2[j, 2]
 *         q = s2[j+1,1]             # <<<<<<<<<<<<<<
 *         tridiag_1d_c(d[u, v:q, w], d[u, v:q, w], b, c, b0, c0, b0, c0)
 ...
 */
    ...
    __pyx_v_q = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s2.data + __pyx_t_6 * __pyx_v_s2.strides[0]) ) + __pyx_t_5 * __pyx_v_s2.strides[1]) )));

    /* "febid/libraries/pde/tridiag.pyx":66
 *         w = s2[j, 2]
 *         q = s2[j+1,1]
 *         tridiag_1d_c(d[u, v:q, w], d[u, v:q, w], b, c, b0, c0, b0, c0)             # <<<<<<<<<<<<<<
 *     # for j in prange(0, s3.shape[0], 2, num_threads=4, nogil=True):
...
{
    Py_ssize_t __pyx_tmp_idx = __pyx_v_w;
        Py_ssize_t __pyx_tmp_shape = __pyx_v_d.shape[2];
    Py_ssize_t __pyx_tmp_stride = __pyx_v_d.strides[2];
        if (__pyx_tmp_idx < 0)
            __pyx_tmp_idx += __pyx_tmp_shape;
        if (unlikely(!__Pyx_is_valid_index(__pyx_tmp_idx, __pyx_tmp_shape))) {
            PyErr_SetString(PyExc_IndexError,
...
__pyx_f_5febid_9libraries_3pde_7tridiag_tridiag_1d_c(__pyx_t_9, __pyx_t_8, __pyx_v_b, __pyx_v_c, __pyx_v_b0, __pyx_v_c0, __pyx_v_b0, __pyx_v_c0);
    __PYX_XDEC_MEMVIEW(&__pyx_t_9, 1);
    __pyx_t_9.memview = NULL;
    __pyx_t_9.data = NULL;
    __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
  ...
  /* "febid/libraries/pde/tridiag.pyx":68
 *         tridiag_1d_c(d[u, v:q, w], d[u, v:q, w], b, c, b0, c0, b0, c0)
 *     # for j in prange(0, s3.shape[0], 2, num_threads=4, nogil=True):
 *     for j in range(0, s3.shape[0], 2):             # <<<<<<<<<<<<<<
 *         u = s3[j, 0]
 *         v = s3[j, 1]
 */
  __pyx_t_2 = (__pyx_v_s3.shape[0]);
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=2) {
    __pyx_v_j = __pyx_t_4;

    /* "febid/libraries/pde/tridiag.pyx":69
 *     # for j in prange(0, s3.shape[0], 2, num_threads=4, nogil=True):
 *     for j in range(0, s3.shape[0], 2):
 *         u = s3[j, 0]             # <<<<<<<<<<<<<<
 *         v = s3[j, 1]
 ...
 */
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_s3.shape[0];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_s3.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_6 < 0) {
      __pyx_t_6 += __pyx_v_s3.shape[1];
      if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_6 >= __pyx_v_s3.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 69, __pyx_L1_error)
    }
    __pyx_v_u = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s3.data + __pyx_t_5 * __pyx_v_s3.strides[0]) ) + __pyx_t_6 * __pyx_v_s3.strides[1]) )));

    /* "febid/libraries/pde/tridiag.pyx":70
 *     for j in range(0, s3.shape[0], 2):
 *         u = s3[j, 0]
 *         v = s3[j, 1]             # <<<<<<<<<<<<<<
 *         w = s3[j, 2]
 ...
 */
    ...
    __pyx_t_7 = -1;
    if (__pyx_t_6 < 0) {
      __pyx_t_6 += __pyx_v_s3.shape[0];
      if (unlikely(__pyx_t_6 < 0)) __pyx_t_7 = 0;
    } else if (unlikely(__pyx_t_6 >= __pyx_v_s3.shape[0])) __pyx_t_7 = 0;
    if (__pyx_t_5 < 0) {
      __pyx_t_5 += __pyx_v_s3.shape[1];
      if (unlikely(__pyx_t_5 < 0)) __pyx_t_7 = 1;
    } else if (unlikely(__pyx_t_5 >= __pyx_v_s3.shape[1])) __pyx_t_7 = 1;
    if (unlikely(__pyx_t_7 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_7);
      __PYX_ERR(0, 70, __pyx_L1_error)
    }
    __pyx_v_v = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s3.data + __pyx_t_6 * __pyx_v_s3.strides[0]) ) + __pyx_t_5 * __pyx_v_s3.strides[1]) )));

    /* "febid/libraries/pde/tridiag.pyx":71
 *         u = s3[j, 0]
 *         v = s3[j, 1]
 *         w = s3[j, 2]             # <<<<<<<<<<<<<<
 *         q = s3[j+1,0]
 ...
 */
    ...
    __pyx_v_w = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s3.data + __pyx_t_5 * __pyx_v_s3.strides[0]) ) + __pyx_t_6 * __pyx_v_s3.strides[1]) )));

    /* "febid/libraries/pde/tridiag.pyx":72
 *         v = s3[j, 1]
 *         w = s3[j, 2]
 *         q = s3[j+1,0]             # <<<<<<<<<<<<<<
 *         if u == 0:
 ...
 */
    ...
    __pyx_v_q = (*((long *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_s3.data + __pyx_t_6 * __pyx_v_s3.strides[0]) ) + __pyx_t_5 * __pyx_v_s3.strides[1]) )));

    /* "febid/libraries/pde/tridiag.pyx":73
 *         w = s3[j, 2]
 *         q = s3[j+1,0]
 *         if u == 0:             # <<<<<<<<<<<<<<
 *             bn = 1
 ...
 */
    ...
    if (__pyx_t_1) {
      ...
      /* "febid/libraries/pde/tridiag.pyx":74
 *         q = s3[j+1,0]
 *         if u == 0:
 *             bn = 1             # <<<<<<<<<<<<<<
 *             cn = 0
 ...
 */
      ...
      /* "febid/libraries/pde/tridiag.pyx":75
 *         if u == 0:
 *             bn = 1
 *             cn = 0             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
    ...
    /* "febid/libraries/pde/tridiag.pyx":77
 *             cn = 0
 *         else:
 *             bn = b0             # <<<<<<<<<<<<<<
 *             cn = c0
 ...
 */
    /*else*/ {
      __pyx_v_bn = __pyx_v_b0;

      /* "febid/libraries/pde/tridiag.pyx":78
 *         else:
 *             bn = b0
 *             cn = c0             # <<<<<<<<<<<<<<
 *         tridiag_1d_c(d[u:q, v, w], d[u:q, v, w], b, c, bn, cn, b0, c0)
 * 
 */
      __pyx_v_cn = __pyx_v_c0;
    }
    __pyx_L12:;

    /* "febid/libraries/pde/tridiag.pyx":79
 *             bn = b0
 *             cn = c0
 *         tridiag_1d_c(d[u:q, v, w], d[u:q, v, w], b, c, bn, cn, b0, c0)             # <<<<<<<<<<<<<<
 * 
...
__pyx_f_5febid_9libraries_3pde_7tridiag_tridiag_1d_c(__pyx_t_8, __pyx_t_9, __pyx_v_b, __pyx_v_c, __pyx_v_bn, __pyx_v_cn, __pyx_v_b0, __pyx_v_c0);
    __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
    __pyx_t_8.memview = NULL;
    __pyx_t_8.data = NULL;
    __PYX_XDEC_MEMVIEW(&__pyx_t_9, 1);
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_t_9, 1);
  __Pyx_AddTraceback("febid.libraries.pde.tridiag.adi_3d_indexing", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
static PyObject *__pyx_pw_5febid_9libraries_3pde_7tridiag_1adi_3d_indexing(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_memviewslice __pyx_v_s3 = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_a;
  long __pyx_v_boundaries;
  int __pyx_lineno = 0;
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("adi_3d_indexing (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_d,&__pyx_n_s_x,&__pyx_n_s_s1,&__pyx_n_s_s2,&__pyx_n_s_s3,&__pyx_n_s_a,&__pyx_n_s_boundaries,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("adi_3d_indexing", 1, 7, 7, 1); __PYX_ERR(0, 25, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_s1)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("adi_3d_indexing", 1, 7, 7, 2); __PYX_ERR(0, 25, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_s2)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("adi_3d_indexing", 1, 7, 7, 3); __PYX_ERR(0, 25, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_s3)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("adi_3d_indexing", 1, 7, 7, 4); __PYX_ERR(0, 25, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("adi_3d_indexing", 1, 7, 7, 5); __PYX_ERR(0, 25, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_boundaries)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("adi_3d_indexing", 1, 7, 7, 6); __PYX_ERR(0, 25, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "adi_3d_indexing") < 0)) __PYX_ERR(0, 25, __pyx_L3_error)
      }
    ...
    __pyx_v_d = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_d.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_s1 = __Pyx_PyObject_to_MemoryviewSlice_dsds_long(values[2], PyBUF_WRITABLE); if (unlikely(!__pyx_v_s1.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_s2 = __Pyx_PyObject_to_MemoryviewSlice_dsds_long(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_s2.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_s3 = __Pyx_PyObject_to_MemoryviewSlice_dsds_long(values[4], PyBUF_WRITABLE); if (unlikely(!__pyx_v_s3.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_a = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_a == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
    __pyx_v_boundaries = __Pyx_PyInt_As_long(values[6]); if (unlikely((__pyx_v_boundaries == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 25, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("adi_3d_indexing", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 25, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("febid.libraries.pde.tridiag.adi_3d_indexing", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5febid_9libraries_3pde_7tridiag_adi_3d_indexing(__pyx_self, __pyx_v_d, __pyx_v_x, __pyx_v_s1, __pyx_v_s2, __pyx_v_s3, __pyx_v_a, __pyx_v_boundaries);
...
static PyObject *__pyx_pf_5febid_9libraries_3pde_7tridiag_adi_3d_indexing(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_s1, __Pyx_memviewslice __pyx_v_s2, __Pyx_memviewslice __pyx_v_s3, double __pyx_v_a, long __pyx_v_boundaries) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  ...
  if (unlikely(!__pyx_v_d.memview)) { __Pyx_RaiseUnboundLocalError("d"); __PYX_ERR(0, 25, __pyx_L1_error) }
  if (unlikely(!__pyx_v_x.memview)) { __Pyx_RaiseUnboundLocalError("x"); __PYX_ERR(0, 25, __pyx_L1_error) }
  if (unlikely(!__pyx_v_s1.memview)) { __Pyx_RaiseUnboundLocalError("s1"); __PYX_ERR(0, 25, __pyx_L1_error) }
  if (unlikely(!__pyx_v_s2.memview)) { __Pyx_RaiseUnboundLocalError("s2"); __PYX_ERR(0, 25, __pyx_L1_error) }
  if (unlikely(!__pyx_v_s3.memview)) { __Pyx_RaiseUnboundLocalError("s3"); __PYX_ERR(0, 25, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_5febid_9libraries_3pde_7tridiag_adi_3d_indexing(__pyx_v_d, __pyx_v_x, __pyx_v_s1, __pyx_v_s2, __pyx_v_s3, __pyx_v_a, __pyx_v_boundaries, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 25, __pyx_L1_error)
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_v_s3, 1);
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
  return __pyx_r;
}

/* "febid/libraries/pde/tridiag.pyx":84
 * @cython.boundscheck(False) # turn off bounds-checking for entire function
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
...
static PyObject *__pyx_pw_5febid_9libraries_3pde_7tridiag_3adi_3d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_5febid_9libraries_3pde_7tridiag_adi_3d(__Pyx_memviewslice __pyx_v_d, CYTHON_UNUSED __Pyx_memviewslice __pyx_v_x, double __pyx_v_a, long __pyx_v_boundaries, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_i;
  int __pyx_v_j;
  double __pyx_v_b0;
  double __pyx_v_c0;
  ...
  const char *__pyx_filename = NULL;
  int __pyx_clineno = 0;
  __Pyx_RefNannySetupContext("adi_3d", 0);

  /* "febid/libraries/pde/tridiag.pyx":96
 *         int i, j
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "febid/libraries/pde/tridiag.pyx":97
 *         double b0, c0 # boundary conditions
 *     if boundaries == 0:
 *         b0 = 1 + 2 * a             # <<<<<<<<<<<<<<
 *         c0 = -a
 ...
 */
    ...
    /* "febid/libraries/pde/tridiag.pyx":98
 *     if boundaries == 0:
 *         b0 = 1 + 2 * a
 *         c0 = -a             # <<<<<<<<<<<<<<
 *     if boundaries == 1:
 ...
 */
  ...
  /* "febid/libraries/pde/tridiag.pyx":99
 *         b0 = 1 + 2 * a
 *         c0 = -a
 *     if boundaries == 1:             # <<<<<<<<<<<<<<
 *         b0 = 1
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "febid/libraries/pde/tridiag.pyx":100
 *         c0 = -a
 *     if boundaries == 1:
 *         b0 = 1             # <<<<<<<<<<<<<<
 *         c0 = 0
 ...
 */
    ...
    /* "febid/libraries/pde/tridiag.pyx":101
 *     if boundaries == 1:
 *         b0 = 1
 *         c0 = 0             # <<<<<<<<<<<<<<
 *     if boundaries == 2:
 ...
 */
  ...
  /* "febid/libraries/pde/tridiag.pyx":102
 *         b0 = 1
 *         c0 = 0
 *     if boundaries == 2:             # <<<<<<<<<<<<<<
 *         b0 = 1 + 1 * a
 ...
 */
  ...
  if (__pyx_t_1) {
    ...
    /* "febid/libraries/pde/tridiag.pyx":103
 *         c0 = 0
 *     if boundaries == 2:
 *         b0 = 1 + 1 * a             # <<<<<<<<<<<<<<
 *         c0 = -a
 ...
 */
    ...
    /* "febid/libraries/pde/tridiag.pyx":104
 *     if boundaries == 2:
 *         b0 = 1 + 1 * a
 *         c0 = -a             # <<<<<<<<<<<<<<
 *     b = 1 + 2 * a
 ...
 */
  ...
  /* "febid/libraries/pde/tridiag.pyx":105
 *         b0 = 1 + 1 * a
 *         c0 = -a
 *     b = 1 + 2 * a             # <<<<<<<<<<<<<<
 *     c = -a
 ...
 */
  ...
  /* "febid/libraries/pde/tridiag.pyx":106
 *         c0 = -a
 *     b = 1 + 2 * a
 *     c = -a             # <<<<<<<<<<<<<<
 *     for i in range(d.shape[0]):
 ...
 */
  ...
  /* "febid/libraries/pde/tridiag.pyx":107
 *     b = 1 + 2 * a
 *     c = -a
 *     for i in range(d.shape[0]):             # <<<<<<<<<<<<<<
 *         for j in prange(d.shape[1], num_threads=4, nogil=True):
 *         # for j in range(100):
 */
  __pyx_t_2 = (__pyx_v_d.shape[0]);
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "febid/libraries/pde/tridiag.pyx":108
 *     c = -a
 *     for i in range(d.shape[0]):
 *         for j in prange(d.shape[1], num_threads=4, nogil=True):             # <<<<<<<<<<<<<<
 *         # for j in range(100):
 ...
 */
    {
        ...
        #endif
        /*try:*/ {
          if (unlikely(!__pyx_v_d.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("d"); __PYX_ERR(0, 108, __pyx_L11_error) }
          ...
          if ((1 == 0)) abort();
          {
              ...
              {
                  #ifdef _OPENMP
                  #pragma omp parallel num_threads(4) firstprivate(__pyx_t_8, __pyx_t_9)
                  #endif /* _OPENMP */
                  {
                      #ifdef _OPENMP
                      ...
                      for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_7; __pyx_t_6++){
                          {
                              ...
                              /* "febid/libraries/pde/tridiag.pyx":110
 *         for j in prange(d.shape[1], num_threads=4, nogil=True):
 *         # for j in range(100):
 *             tridiag_1d_c(d[i, j, :], d[i, j, :], b, c, b0, c0, b0, c0)             # <<<<<<<<<<<<<<
 *     for i in range(d.shape[0]):
...
__pyx_t_8.shape[0] = __pyx_v_d.shape[2];
__pyx_t_8.strides[0] = __pyx_v_d.strides[2];
...
__pyx_t_9.shape[0] = __pyx_v_d.shape[2];
__pyx_t_9.strides[0] = __pyx_v_d.strides[2];
 ...
 */
  ...
  /* "febid/libraries/pde/tridiag.pyx":111
 *         # for j in range(100):
 *             tridiag_1d_c(d[i, j, :], d[i, j, :], b, c, b0, c0, b0, c0)
 *     for i in range(d.shape[0]):             # <<<<<<<<<<<<<<
 *         for j in prange(d.shape[2], num_threads=4, nogil=True):
 ...
 */
  ...
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    ...
    /* "febid/libraries/pde/tridiag.pyx":112
 *             tridiag_1d_c(d[i, j, :], d[i, j, :], b, c, b0, c0, b0, c0)
 *     for i in range(d.shape[0]):
 *         for j in prange(d.shape[2], num_threads=4, nogil=True):             # <<<<<<<<<<<<<<
 *             tridiag_1d_c(d[i, :, j], d[i, :, j], b, c, b0, c0, b0, c0)
 ...
 */
    {
        ...
        #endif
        /*try:*/ {
          if (unlikely(!__pyx_v_d.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("d"); __PYX_ERR(0, 112, __pyx_L24_error) }
          __pyx_t_7 = (__pyx_v_d.shape[2]);
          if ((1 == 0)) abort();
          {
              #if ((defined(__APPLE__) || defined(__OSX__)) && (defined(__GNUC__) && (__GNUC__ > 2 || (__GNUC__ == 2 && (__GNUC_MINOR__ > 95)))))
                  #undef likely
                      ...
                      for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_5; __pyx_t_6++){
                          {
                              ...
                              /* "febid/libraries/pde/tridiag.pyx":113
 *     for i in range(d.shape[0]):
 *         for j in prange(d.shape[2], num_threads=4, nogil=True):
 *             tridiag_1d_c(d[i, :, j], d[i, :, j], b, c, b0, c0, b0, c0)             # <<<<<<<<<<<<<<
 *     for i in range(d.shape[1]):
...
__pyx_t_9.shape[0] = __pyx_v_d.shape[1];
__pyx_t_9.strides[0] = __pyx_v_d.strides[1];
    __pyx_t_9.suboffsets[0] = -1;
...
__pyx_t_8.shape[0] = __pyx_v_d.shape[1];
__pyx_t_8.strides[0] = __pyx_v_d.strides[1];
    __pyx_t_8.suboffsets[0] = -1;
 ...
 */
  ...
  /* "febid/libraries/pde/tridiag.pyx":114
 *         for j in prange(d.shape[2], num_threads=4, nogil=True):
 *             tridiag_1d_c(d[i, :, j], d[i, :, j], b, c, b0, c0, b0, c0)
 *     for i in range(d.shape[1]):             # <<<<<<<<<<<<<<
 *         for j in prange(d.shape[2], num_threads=4, nogil=True):
 *             tridiag_1d_c(d[:, i, j], d[:, i, j], b, c, b0, c0, b0, c0)
 */
  __pyx_t_2 = (__pyx_v_d.shape[1]);
  __pyx_t_3 = __pyx_t_2;
  for (__pyx_t_4 = 0; __pyx_t_4 < __pyx_t_3; __pyx_t_4+=1) {
    __pyx_v_i = __pyx_t_4;

    /* "febid/libraries/pde/tridiag.pyx":115
 *             tridiag_1d_c(d[i, :, j], d[i, :, j], b, c, b0, c0, b0, c0)
 *     for i in range(d.shape[1]):
 *         for j in prange(d.shape[2], num_threads=4, nogil=True):             # <<<<<<<<<<<<<<
 *             tridiag_1d_c(d[:, i, j], d[:, i, j], b, c, b0, c0, b0, c0)
 ...
 */
    {
        ...
        #endif
        /*try:*/ {
          if (unlikely(!__pyx_v_d.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("d"); __PYX_ERR(0, 115, __pyx_L37_error) }
          __pyx_t_5 = (__pyx_v_d.shape[2]);
          if ((1 == 0)) abort();
          {
              #if ((defined(__APPLE__) || defined(__OSX__)) && (defined(__GNUC__) && (__GNUC__ > 2 || (__GNUC__ == 2 && (__GNUC_MINOR__ > 95)))))
                  #undef likely
                      ...
                      for (__pyx_t_6 = 0; __pyx_t_6 < __pyx_t_7; __pyx_t_6++){
                          {
                              ...
                              /* "febid/libraries/pde/tridiag.pyx":116
 *     for i in range(d.shape[1]):
 *         for j in prange(d.shape[2], num_threads=4, nogil=True):
 *             tridiag_1d_c(d[:, i, j], d[:, i, j], b, c, b0, c0, b0, c0)             # <<<<<<<<<<<<<<
 * 
 ...
 */
                              ...
                              __pyx_t_8.memview = __pyx_v_d.memview;
                              __PYX_INC_MEMVIEW(&__pyx_t_8, 0);
                              __pyx_t_8.shape[0] = __pyx_v_d.shape[0];
__pyx_t_8.strides[0] = __pyx_v_d.strides[0];
    __pyx_t_8.suboffsets[0] = -1;
...
__pyx_t_9.data = __pyx_v_d.data;
                              __pyx_t_9.memview = __pyx_v_d.memview;
                              __PYX_INC_MEMVIEW(&__pyx_t_9, 0);
                              __pyx_t_9.shape[0] = __pyx_v_d.shape[0];
__pyx_t_9.strides[0] = __pyx_v_d.strides[0];
    __pyx_t_9.suboffsets[0] = -1;
 ...
 */
  ...
  __PYX_XDEC_MEMVIEW(&__pyx_t_8, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_t_9, 1);
  __Pyx_AddTraceback("febid.libraries.pde.tridiag.adi_3d", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
  __Pyx_XGIVEREF(__pyx_r);
  __Pyx_RefNannyFinishContext();
...
/* Python wrapper */
static PyObject *__pyx_pw_5febid_9libraries_3pde_7tridiag_3adi_3d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_5febid_9libraries_3pde_7tridiag_2adi_3d[] = "\n    Solve a PDE in 3D uniform domain using ADI method with backward Euler scheme. \n    \n    :param d: right hand side vector\n    :param x: vector to be solved\n    :param a: equation coefficient\n    :param boundaries: type of boundary conditions: 0 for 0 at boundaries, 1 for fixed boundaries, 2 for no flow through boundaries\n    ";
static PyObject *__pyx_pw_5febid_9libraries_3pde_7tridiag_3adi_3d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_d = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  double __pyx_v_a;
  long __pyx_v_boundaries;
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("adi_3d (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_d,&__pyx_n_s_x,&__pyx_n_s_a,&__pyx_n_s_boundaries,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("adi_3d", 1, 4, 4, 1); __PYX_ERR(0, 84, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_a)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("adi_3d", 1, 4, 4, 2); __PYX_ERR(0, 84, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_boundaries)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("adi_3d", 1, 4, 4, 3); __PYX_ERR(0, 84, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "adi_3d") < 0)) __PYX_ERR(0, 84, __pyx_L3_error)
      }
    ...
    __pyx_v_d = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_d.memview)) __PYX_ERR(0, 84, __pyx_L3_error)
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_dsdsds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 84, __pyx_L3_error)
    __pyx_v_a = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_a == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 84, __pyx_L3_error)
    __pyx_v_boundaries = __Pyx_PyInt_As_long(values[3]); if (unlikely((__pyx_v_boundaries == (long)-1) && PyErr_Occurred())) __PYX_ERR(0, 84, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("adi_3d", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 84, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("febid.libraries.pde.tridiag.adi_3d", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5febid_9libraries_3pde_7tridiag_2adi_3d(__pyx_self, __pyx_v_d, __pyx_v_x, __pyx_v_a, __pyx_v_boundaries);
...
static PyObject *__pyx_pf_5febid_9libraries_3pde_7tridiag_2adi_3d(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d, __Pyx_memviewslice __pyx_v_x, double __pyx_v_a, long __pyx_v_boundaries) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("adi_3d", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_d.memview)) { __Pyx_RaiseUnboundLocalError("d"); __PYX_ERR(0, 84, __pyx_L1_error) }
  if (unlikely(!__pyx_v_x.memview)) { __Pyx_RaiseUnboundLocalError("x"); __PYX_ERR(0, 84, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_5febid_9libraries_3pde_7tridiag_adi_3d(__pyx_v_d, __pyx_v_x, __pyx_v_a, __pyx_v_boundaries, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 84, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "febid/libraries/pde/tridiag.pyx":118
 *             tridiag_1d_c(d[:, i, j], d[:, i, j], b, c, b0, c0, b0, c0)
 * 
 * cpdef tridiag_1d(double[:] d, double[:] x, double b, double c, double b0, double c0):             # <<<<<<<<<<<<<<
 *     """
...
static PyObject *__pyx_pw_5febid_9libraries_3pde_7tridiag_5tridiag_1d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_5febid_9libraries_3pde_7tridiag_tridiag_1d(__Pyx_memviewslice __pyx_v_d, __Pyx_memviewslice __pyx_v_x, double __pyx_v_b, double __pyx_v_c, double __pyx_v_b0, double __pyx_v_c0, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("tridiag_1d", 0);

  /* "febid/libraries/pde/tridiag.pyx":132
 *     :return:
 *     """
 ...
 * @cython.boundscheck(False) # turn off bounds-checking for entire function
 */
  __pyx_f_5febid_9libraries_3pde_7tridiag_tridiag_1d_c(__pyx_v_d, __pyx_v_x, __pyx_v_b, __pyx_v_c, __pyx_v_b0, __pyx_v_c0, __pyx_v_b0, __pyx_v_c0);
...
static PyObject *__pyx_pw_5febid_9libraries_3pde_7tridiag_5tridiag_1d(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("tridiag_1d (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_d,&__pyx_n_s_x,&__pyx_n_s_b,&__pyx_n_s_c,&__pyx_n_s_b0,&__pyx_n_s_c0,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_x)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("tridiag_1d", 1, 6, 6, 1); __PYX_ERR(0, 118, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_b)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("tridiag_1d", 1, 6, 6, 2); __PYX_ERR(0, 118, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("tridiag_1d", 1, 6, 6, 3); __PYX_ERR(0, 118, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_b0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("tridiag_1d", 1, 6, 6, 4); __PYX_ERR(0, 118, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_c0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("tridiag_1d", 1, 6, 6, 5); __PYX_ERR(0, 118, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "tridiag_1d") < 0)) __PYX_ERR(0, 118, __pyx_L3_error)
      }
    ...
    __pyx_v_d = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_d.memview)) __PYX_ERR(0, 118, __pyx_L3_error)
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[1], PyBUF_WRITABLE); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 118, __pyx_L3_error)
    __pyx_v_b = __pyx_PyFloat_AsDouble(values[2]); if (unlikely((__pyx_v_b == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 118, __pyx_L3_error)
    __pyx_v_c = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_c == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 118, __pyx_L3_error)
    __pyx_v_b0 = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_b0 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 118, __pyx_L3_error)
    __pyx_v_c0 = __pyx_PyFloat_AsDouble(values[5]); if (unlikely((__pyx_v_c0 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 118, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("tridiag_1d", 1, 6, 6, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 118, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("febid.libraries.pde.tridiag.tridiag_1d", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_5febid_9libraries_3pde_7tridiag_4tridiag_1d(__pyx_self, __pyx_v_d, __pyx_v_x, __pyx_v_b, __pyx_v_c, __pyx_v_b0, __pyx_v_c0);
...
static PyObject *__pyx_pf_5febid_9libraries_3pde_7tridiag_4tridiag_1d(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_d, __Pyx_memviewslice __pyx_v_x, double __pyx_v_b, double __pyx_v_c, double __pyx_v_b0, double __pyx_v_c0) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  int __pyx_lineno = 0;
  ...
  __Pyx_RefNannySetupContext("tridiag_1d", 0);
  __Pyx_XDECREF(__pyx_r);
  if (unlikely(!__pyx_v_d.memview)) { __Pyx_RaiseUnboundLocalError("d"); __PYX_ERR(0, 118, __pyx_L1_error) }
  if (unlikely(!__pyx_v_x.memview)) { __Pyx_RaiseUnboundLocalError("x"); __PYX_ERR(0, 118, __pyx_L1_error) }
  __pyx_t_1 = __pyx_f_5febid_9libraries_3pde_7tridiag_tridiag_1d(__pyx_v_d, __pyx_v_x, __pyx_v_b, __pyx_v_c, __pyx_v_b0, __pyx_v_c0, 0); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 118, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
/* "febid/libraries/pde/tridiag.pyx":136
 * @cython.boundscheck(False) # turn off bounds-checking for entire function
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
...
static void __pyx_f_5febid_9libraries_3pde_7tridiag_tridiag_1d_c(__Pyx_memviewslice __pyx_v_d, __Pyx_memviewslice __pyx_v_x, double __pyx_v_b, double __pyx_v_c, double __pyx_v_b0, double __pyx_v_c0, double __pyx_v_bn, double __pyx_v_cn) {
  int __pyx_v_i;
  int __pyx_v_N;
  ...
  #endif
  __Pyx_RefNannySetupContext("tridiag_1d_c", 1);

  /* "febid/libraries/pde/tridiag.pyx":137
 * @cython.wraparound(False)  # turn off negative index wrapping for entire function
 * cdef void tridiag_1d_c(double[:] d, double[:] x, double b, double c, double b0, double c0, double bn, double cn) nogil:
 *     """             # <<<<<<<<<<<<<<
 *     Tridiagonal matrix solver
 ...
 */
  /*try:*/ {
    ...
    /* "febid/libraries/pde/tridiag.pyx":153
 *     cdef:
 *         int i, N
 ...
 *     N = d.shape[0] - 1
 */
    __pyx_v_gamma = ((double *)malloc(((__pyx_v_d.shape[0]) * (sizeof(double)))));

    /* "febid/libraries/pde/tridiag.pyx":154
 *         int i, N
 *         double *gamma = <double*>malloc(d.shape[0] * sizeof(double))
 *         double *rho = <double*>malloc(d.shape[0] * sizeof(double))             # <<<<<<<<<<<<<<
 *     N = d.shape[0] - 1
 *     gamma[0] = c0/b0
 */
    __pyx_v_rho = ((double *)malloc(((__pyx_v_d.shape[0]) * (sizeof(double)))));

    /* "febid/libraries/pde/tridiag.pyx":155
 *         double *gamma = <double*>malloc(d.shape[0] * sizeof(double))
 *         double *rho = <double*>malloc(d.shape[0] * sizeof(double))
 *     N = d.shape[0] - 1             # <<<<<<<<<<<<<<
 *     gamma[0] = c0/b0
 *     rho[0] = d[0]/b0
 */
    __pyx_v_N = ((__pyx_v_d.shape[0]) - 1);

    /* "febid/libraries/pde/tridiag.pyx":156
 *         double *rho = <double*>malloc(d.shape[0] * sizeof(double))
 *     N = d.shape[0] - 1
 *     gamma[0] = c0/b0             # <<<<<<<<<<<<<<
 *     rho[0] = d[0]/b0
 ...
 */
    ...
    (__pyx_v_gamma[0]) = (__pyx_v_c0 / __pyx_v_b0);

    /* "febid/libraries/pde/tridiag.pyx":157
 *     N = d.shape[0] - 1
 *     gamma[0] = c0/b0
 *     rho[0] = d[0]/b0             # <<<<<<<<<<<<<<
 *     for i in range(1, N+1):
 ...
 */
    ...
    (__pyx_v_rho[0]) = (__pyx_t_2 / __pyx_v_b0);

    /* "febid/libraries/pde/tridiag.pyx":158
 *     gamma[0] = c0/b0
 *     rho[0] = d[0]/b0
 *     for i in range(1, N+1):             # <<<<<<<<<<<<<<
 *         gamma[i] = c / (b - c * gamma[i - 1])
 ...
 */
    ...
    for (__pyx_t_5 = 1; __pyx_t_5 < __pyx_t_4; __pyx_t_5+=1) {
      ...
      /* "febid/libraries/pde/tridiag.pyx":159
 *     rho[0] = d[0]/b0
 *     for i in range(1, N+1):
 *         gamma[i] = c / (b - c * gamma[i - 1])             # <<<<<<<<<<<<<<
 *         rho[i] = (d[i] - c * rho[i - 1]) / (b - c * gamma[i - 1])
 ...
 */
      __pyx_t_2 = (__pyx_v_b - (__pyx_v_c * (__pyx_v_gamma[(__pyx_v_i - 1)])));
      ...
      (__pyx_v_gamma[__pyx_v_i]) = (__pyx_v_c / __pyx_t_2);

      /* "febid/libraries/pde/tridiag.pyx":160
 *     for i in range(1, N+1):
 *         gamma[i] = c / (b - c * gamma[i - 1])
 *         rho[i] = (d[i] - c * rho[i - 1]) / (b - c * gamma[i - 1])             # <<<<<<<<<<<<<<
 *     rho[N] = (d[N] - cn * rho[N-1]) / (bn - cn * gamma[N-1])
 ...
 */
      __pyx_t_1 = __pyx_v_i;
      __pyx_t_2 = ((*((double *) ( /* dim=0 */ (__pyx_v_d.data + __pyx_t_1 * __pyx_v_d.strides[0]) ))) - (__pyx_v_c * (__pyx_v_rho[(__pyx_v_i - 1)])));
      __pyx_t_6 = (__pyx_v_b - (__pyx_v_c * (__pyx_v_gamma[(__pyx_v_i - 1)])));
      ...
      (__pyx_v_rho[__pyx_v_i]) = (__pyx_t_2 / __pyx_t_6);
    }

    /* "febid/libraries/pde/tridiag.pyx":161
 *         gamma[i] = c / (b - c * gamma[i - 1])
 *         rho[i] = (d[i] - c * rho[i - 1]) / (b - c * gamma[i - 1])
 *     rho[N] = (d[N] - cn * rho[N-1]) / (bn - cn * gamma[N-1])             # <<<<<<<<<<<<<<
 *     x[N] = rho[N]
 ...
 */
    __pyx_t_1 = __pyx_v_N;
    __pyx_t_6 = ((*((double *) ( /* dim=0 */ (__pyx_v_d.data + __pyx_t_1 * __pyx_v_d.strides[0]) ))) - (__pyx_v_cn * (__pyx_v_rho[(__pyx_v_N - 1)])));
    __pyx_t_2 = (__pyx_v_bn - (__pyx_v_cn * (__pyx_v_gamma[(__pyx_v_N - 1)])));
    if (unlikely(__pyx_t_2 == 0)) {
      #ifdef WITH_THREAD
      PyGILState_STATE __pyx_gilstate_save = __Pyx_PyGILState_Ensure();
      #endif
    ...
    (__pyx_v_rho[__pyx_v_N]) = (__pyx_t_6 / __pyx_t_2);

    /* "febid/libraries/pde/tridiag.pyx":162
 *         rho[i] = (d[i] - c * rho[i - 1]) / (b - c * gamma[i - 1])
 *     rho[N] = (d[N] - cn * rho[N-1]) / (bn - cn * gamma[N-1])
 *     x[N] = rho[N]             # <<<<<<<<<<<<<<
 *     for i in range(N-1, -1, -1):
 ...
 */
    __pyx_t_1 = __pyx_v_N;
    *((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_1 * __pyx_v_x.strides[0]) )) = (__pyx_v_rho[__pyx_v_N]);

    /* "febid/libraries/pde/tridiag.pyx":163
 *     rho[N] = (d[N] - cn * rho[N-1]) / (bn - cn * gamma[N-1])
 *     x[N] = rho[N]
 *     for i in range(N-1, -1, -1):             # <<<<<<<<<<<<<<
 *         x[i] = rho[i] - x[i + 1] * gamma[i]
 ...
 */
    for (__pyx_t_5 = (__pyx_v_N - 1); __pyx_t_5 > -1; __pyx_t_5-=1) {
      ...
      /* "febid/libraries/pde/tridiag.pyx":164
 *     x[N] = rho[N]
 *     for i in range(N-1, -1, -1):
 *         x[i] = rho[i] - x[i + 1] * gamma[i]             # <<<<<<<<<<<<<<
 *         if x[i] > 1e6 or x[i] < 0:
 ...
 */
      ...
      __pyx_t_7 = __pyx_v_i;
      *((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_7 * __pyx_v_x.strides[0]) )) = ((__pyx_v_rho[__pyx_v_i]) - ((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_1 * __pyx_v_x.strides[0]) ))) * (__pyx_v_gamma[__pyx_v_i])));

      /* "febid/libraries/pde/tridiag.pyx":165
 *     for i in range(N-1, -1, -1):
 *         x[i] = rho[i] - x[i + 1] * gamma[i]
 *         if x[i] > 1e6 or x[i] < 0:             # <<<<<<<<<<<<<<
 *             with gil:
 ...
 */
      __pyx_t_1 = __pyx_v_i;
      __pyx_t_9 = (((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_1 * __pyx_v_x.strides[0]) ))) > 1e6) != 0);
      if (!__pyx_t_9) {
      } else {
        __pyx_t_8 = __pyx_t_9;
      ...
      __pyx_t_1 = __pyx_v_i;
      __pyx_t_9 = (((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_1 * __pyx_v_x.strides[0]) ))) < 0.0) != 0);
      __pyx_t_8 = __pyx_t_9;
      __pyx_L11_bool_binop_done:;
      if (__pyx_t_8) {

        /* "febid/libraries/pde/tridiag.pyx":166
 *         x[i] = rho[i] - x[i + 1] * gamma[i]
 *         if x[i] > 1e6 or x[i] < 0:
 *             with gil:             # <<<<<<<<<<<<<<
 *                 for N in range(x.shape[0]):
 ...
 */
        {
            ...
            /*try:*/ {
              ...
              /* "febid/libraries/pde/tridiag.pyx":167
 *         if x[i] > 1e6 or x[i] < 0:
 *             with gil:
 *                 for N in range(x.shape[0]):             # <<<<<<<<<<<<<<
 *                     print(x[N+1])
 ...
 */
              ...
              for (__pyx_t_12 = 0; __pyx_t_12 < __pyx_t_11; __pyx_t_12+=1) {
                ...
                /* "febid/libraries/pde/tridiag.pyx":168
 *             with gil:
 *                 for N in range(x.shape[0]):
 *                     print(x[N+1])             # <<<<<<<<<<<<<<
 *                 raise RuntimeError("Exceeding 1e6 iterations in tridiagonal matrix solution")
 ...
 */
                ...
                __pyx_t_13 = PyFloat_FromDouble((*((double *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_1 * __pyx_v_x.strides[0]) )))); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 168, __pyx_L16_error)
                __Pyx_GOTREF(__pyx_t_13);
                if (__Pyx_PrintOne(0, __pyx_t_13) < 0) __PYX_ERR(0, 168, __pyx_L16_error)
                __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
              }

              /* "febid/libraries/pde/tridiag.pyx":169
 *                 for N in range(x.shape[0]):
 *                     print(x[N+1])
 *                 raise RuntimeError("Exceeding 1e6 iterations in tridiagonal matrix solution")             # <<<<<<<<<<<<<<
 *     free(gamma)
 *     free(rho)
 */
              __pyx_t_13 = __Pyx_PyObject_Call(__pyx_builtin_RuntimeError, __pyx_tuple_, NULL); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 169, __pyx_L16_error)
              __Pyx_GOTREF(__pyx_t_13);
 ...
 */
    ...
    /* "febid/libraries/pde/tridiag.pyx":170
 *                     print(x[N+1])
 *                 raise RuntimeError("Exceeding 1e6 iterations in tridiagonal matrix solution")
 *     free(gamma)             # <<<<<<<<<<<<<<
 *     free(rho)
 ...
 */
    ...
    /* "febid/libraries/pde/tridiag.pyx":171
 *                 raise RuntimeError("Exceeding 1e6 iterations in tridiagonal matrix solution")
 *     free(gamma)
 *     free(rho)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __Pyx_WriteUnraisable("febid.libraries.pde.tridiag.tridiag_1d_c", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 1);
  __pyx_L0:;
  #ifdef WITH_THREAD
  __Pyx_PyGILState_Release(__pyx_gilstate_save);
  #endif
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "febid.libraries.pde.tridiag.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "febid.libraries.pde.tridiag.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "febid.libraries.pde.tridiag.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "febid.libraries.pde.tridiag._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"adi_3d_indexing", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5febid_9libraries_3pde_7tridiag_1adi_3d_indexing, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5febid_9libraries_3pde_7tridiag_adi_3d_indexing},
  {"adi_3d", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5febid_9libraries_3pde_7tridiag_3adi_3d, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5febid_9libraries_3pde_7tridiag_2adi_3d},
  {"tridiag_1d", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_5febid_9libraries_3pde_7tridiag_5tridiag_1d, METH_VARARGS|METH_KEYWORDS, __pyx_doc_5febid_9libraries_3pde_7tridiag_4tridiag_1d},
  {0, 0, 0, 0}
};
...
static struct PyModuleDef __pyx_moduledef = {
    ...
    "tridiag",
    __pyx_k_Tridiagonal_parallel_matrix_sol, /* m_doc */
  #if CYTHON_PEP489_MULTI_PHASE_INIT
    0, /* m_size */
  #else
    -1, /* m_size */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_Exceeding_1e6_iterations_in_trid, __pyx_k_Exceeding_1e6_iterations_in_trid, sizeof(__pyx_k_Exceeding_1e6_iterations_in_trid), 0, 0, 1, 0},
 ...
 *     free(rho)
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_kp_s_Exceeding_1e6_iterations_in_trid); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 169, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("tridiag", __pyx_methods, __pyx_k_Tridiagonal_parallel_matrix_sol, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_febid__libraries__pde__tridiag) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "febid.libraries.pde.tridiag")) {
      if (unlikely(PyDict_SetItemString(modules, "febid.libraries.pde.tridiag", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "febid/libraries/pde/tridiag.pyx":1
 * """             # <<<<<<<<<<<<<<
 * Tridiagonal parallel matrix solver
 * """
 */
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init febid.libraries.pde.tridiag", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init febid.libraries.pde.tridiag");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
